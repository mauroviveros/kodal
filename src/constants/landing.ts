import { Headset, LucideProps, Mail, MapPin, Palette, Phone, RefreshCcw, ShieldCheck, Smartphone } from "lucide-react";
...
export const SUPPORT_CONTACT_METHODS: { method: string; contact: string; description: string; Icon:Icon }[] = [
  {
    method: 'Teléfono de soporte',
    contact: '+54 9 11 5142-3888',
...
export const FEATURES_LIST: { title: string; description: string; Icon: Icon }[] = [
  {
